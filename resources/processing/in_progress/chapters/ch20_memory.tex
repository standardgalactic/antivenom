...
This chapter's opening noted that any claim affected by
Chapter~\ref{ch:mem8}'s broad reading would be flagged explicitly as it
arose. None was: \cref{prop:memory-relay} and
\cref{prop:memory-no-escape} both rest on \cref{prop:recursive-insufficiency},
which Chapter~\ref{ch:mem8}'s own table records as holding under either
reading. The narrow reading was invoked at the start of this chapter for
its independent empirical support, not because this chapter's
conclusions require it; memory turns out to be a case, unlike the
painting and chess cases of \cref{rem:fork-scope}, where the fork simply
