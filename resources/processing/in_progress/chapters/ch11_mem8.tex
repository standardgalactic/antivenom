...
\cref{prop:verification-sufficiency} (proofs, formal case) & holds & holds \\
\cref{prop:preservation-limit} & holds as stated & upper limit never reached \\
\cref{oq:unmediated-access} & resolved: no & remains open in a stronger form \\
Ch.~\ref{ch:chess}'s physical-board case & fidelity $\to 1$ available & fidelity $\to 1$ unavailable \\
Embodied cases generally, Part~\ref{part:worked-domains} & conditional & structurally revised \\
\bottomrule
\end{tabular}
\end{center}
