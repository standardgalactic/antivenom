...
\usepackage[backend=biber,style=authoryear,maxcitenames=2,uniquename=false,uniquelist=false]{biblatex}

% ============================================================
% Provisional bibliography
% ============================================================
%
% These entries establish the source architecture for the essay's
% citation pass. Publication metadata, page ranges, and access
% dates for entries marked "provisional" should be verified before
% the essay is finalized.
%
